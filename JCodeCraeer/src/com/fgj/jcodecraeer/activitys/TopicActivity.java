...
public class TopicActivity extends Activity {
    ...
    public void prepareView() {
        setTitle(R.string.tab_main5);
        mArticleList = new ArrayList<Article>();
        // final String href = getIntent().getStringExtra("pagetid");
        final String href = "http://www.jcodecraeer.com/plus/freelist.php?lid=12";
        ...
        onwer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent();
                i.setClass(TopicActivity.this, OwnerActivity.class);
                startActivity(i);
            }
        });
        slide_bottom_to_top = AnimationUtils.loadAnimation(TopicActivity.this,
            ...
            public void onClick(View arg0) {
                if (!search.getText().toString().equals("")) {
                    ...
                    try {
                        ...
                        Intent i = new Intent();
                        i.setClass(TopicActivity.this, SubMainActivity.class);
                        i.putExtra("pagetid",
...
//        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                LayoutInflater layoutInflater =
                        LayoutInflater.from(TopicActivity.this);
                viewHolder = new ViewHolder();
                convertView = layoutInflater.inflate(R.layout.item_topic_list, null);
    ...
    public ArrayList<Article> parseArticleList(String href, final int page) {
        ...
        try {
            ...
            Elements articleElements = masthead.select("div.feed-section");
