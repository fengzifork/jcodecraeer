...
public class JcodeHtmlParse {
	private static String URL = "http://www.jcodecraeer.com/plus/list.php?tid=18";
...
//            e.printStackTrace();
//        }
		Waterfall fall = getHtmlArticles("");
	...
	public static Waterfall getHtmlArticles(String url){
		...
		try {
			String html = getHtmlString("http://www.jcodecraeer.com/a/anzhuokaifa/androidkaifa/2014/1117/1992.html");
